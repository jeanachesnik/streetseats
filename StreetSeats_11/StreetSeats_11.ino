...
///*** Jeana's Setup RTC Sensor Additions BEGIN *///////
  {
    ...
    Serial.println ("Setup ALARM 2 - FALSE");


//    RTC.setAlarm (ALM1_MATCH_SECONDS, 0,0,0,1); 
//    RTC.alarm (ALARM_1);
//    RTC.alarmInterrupt (ALARM_1,true);
//    Serial.println ("Setup - ALARM 1 TRUE"); 
...
//    
    ...
    //Set a daily alarm.
    RTC.setAlarm (ALM2_MATCH_HOURS, 0, 28, 21,1);   //daydate parameter should be between 1 and 7
    RTC.alarm(ALARM_2);                   //ensure RTC interrupt flag is cleared
    RTC.alarmInterrupt(ALARM_2, true);
    Serial.println ("Alarm 1B is setup");

    sleep ();
    Serial.println ("Setup - Calling Sleep loop");
