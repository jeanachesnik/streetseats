...
int lighCheckTime = 80000; //how often we check light sensor. 10 minutes will be 600000 milliseconds
...
int nightCountMax = 30; // 18 times 10 minutes will be about 3 hours (10 miuntes / 60 = 6 light tests per hour)
