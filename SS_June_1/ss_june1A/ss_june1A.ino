...
///***Adding Integers and Boolean's to set up running code***///
...
//unsigned long minutes = seconds * 60;
    ...
    int lightTotal;
    int lightAvg;
    int darkVal = 5; //this is our night threshold value in lux
...
//
    //RTC.setAlarm (ALM1_MATCH_HOURS, 0, 0, 16, 1); 
    //RTC.alarm(ALARM_1);                   //ensure RTC interrupt flag is cleared
    //RTC.alarmInterrupt(ALARM_1, true);
...
///** Setting up the code to turn Relays OFF, which equals "Set" ***// 
///** We're stating here that when the Arduino turns on, the lights will be off ***//
...
//**Now all of set up is complete. We've called every item being used with the Arduino**//
//**We've said which pins they'll be using on the Arduino. Now the Arduino will run it's**//
//** Loop which will repeat the code over and over until we tell it to stop.**//
