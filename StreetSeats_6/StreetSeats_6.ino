...
//    RTC.setAlarm(ALM1_EVERY_MINUTE, 0, 0, 02, 1);    //daydate parameter should be between 1 and 7
//    RTC.alarm(ALARM_1);                   //ensure RTC interrupt flag is cleared
//    RTC.alarmInterrupt(ALARM_1, true);
//
//    //Set a daily alarm.
//    RTC.setAlarm(ALM2_MATCH_HOURS, 0, 05, 20, 1);    //daydate parameter should be between 1 and 7
//    RTC.alarm(ALARM_2);                   //ensure RTC interrupt flag is cleared
//    RTC.alarmInterrupt(ALARM_2, true);


    RTC.setAlarm(ALM1_MATCH_HOURS, 0, 09, 21, 1);    //daydate parameter should be between 1 and 7
    RTC.alarm(ALARM_1);                   //ensure RTC interrupt flag is cleared
    RTC.alarmInterrupt(ALARM_1, true);
